...
-   **Real-time Messaging:** Instant messages, history, typing indicators, reactions, @mentions (with notifications), and message deletion. **Smart read tracking** automatically marks messages as read when switching rooms or receiving messages in active rooms.
